...
docker build -t 192.168.1.196:30400/puzzle:$BUILD_TAG -f applications/puzzle/Dockerfile applications/puzzle
...
#Push the images
docker push 192.168.1.196:30400/puzzle:$BUILD_TAG

#Stop the registry proxy
docker stop socat-registry

# Create the deployment and service for the puzzle server aka puzzle
sed 's#192.168.1.196:30400/puzzle:$BUILD_TAG#192.168.1.196:30400/puzzle:'$BUILD_TAG'#' applications/puzzle/k8s/deployment.yaml | kubectl apply -f -
