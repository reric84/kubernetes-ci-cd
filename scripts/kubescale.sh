...
# docker build -t 192.168.1.196:30400/kubescale:$TAG -f 

# # echo "building set image"

# cd set; docker build -t 192.168.1.196:30400/set:$TAG -f set/Dockerfile .
...
# docker push 192.168.1.196:30400/kubescale:latest
# docker push 192.168.1.196:30400/set:latest
